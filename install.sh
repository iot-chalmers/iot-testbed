...
parallel-ssh --timeout 0 --hosts ./server/scripts/all-hosts --user user --inline "if ! grep -q '/home/user/tmp' /etc/fstab; then sudo cat /home/user/fstab >> /etc/fstab; fi; rm -f /home/user/fstab; mkdir -p /home/user/tmp"
