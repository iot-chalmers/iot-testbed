...
if __name__=="__main__":
  ...
  pssh(hosts_path, '"killall -q -9 serialdump"', "Stopping serialdump")
  pssh(hosts_path, '"killall -q -9 picocom"', "Stopping picocom")
  pssh(hosts_path, '"killall -q -9 contiki-timestamp"', "Stopping contiki-timestamp")
